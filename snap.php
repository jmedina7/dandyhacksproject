...
include('inc/html-top.php'); ?>
	...
	<body>
		<div class = trans>
			...
			<main>
				<h2>IThe Supplemental Nutrition Assistance Program (SNAP)</h2>
				...
				<p>Applications can be submitted online 24/7 on NY's website, in person, or through mail.</p>

				<h3>Online</h3>
				<p>To apply for SNAP online in New York, you can visit the myBenefits page by searching or clicking <a href="https://mybenefits.ny.gov/mybenefits/begin">here</a>.</p>

				<h3>In Person</h3>
				<p>For applicants in Rochester, you can apply in person from 8AM-4PM at Monroe County Human Services:</p>
				<ul>
