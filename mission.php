...
include('inc/html-top.php'); ?>
			...
			<main>
				...
				<p>In addition to these features, the website includes a user submission option, where residents of the Rochester area can input their favorite recipes and the approximate budget for their meal.</p>
				<h2>Our Team</h2>
				<p>RocRecipes was created for the 2018 DandyHacks Hackathon in Rochester, NY. The team consists of Jayda Medina (left), Serena Flint, Sarah Field, and Molly Robinson .</p>
